            ...
            <div id="slide1" className="carousel-item relative w-full bg-[url(/banner-1.jpg)] bg-cover bg-no-repeat">
                <div className='flex justify-center items-center w-full'>
                    <div className='text-center space-y-4'>
                        ...
                        <p className='font-semibold text-[10px] md:text-base w-40 md:w-2xl mx-auto'>Effortlessly browse, borrow, and manage books while unlocking endless learning opportunities.</p>
            ...
            <div id="slide2" className="carousel-item relative w-full bg-[url(/banner-2.jpg)] bg-cover bg-no-repeat">
                <div className='flex justify-center items-center w-full text-black'>
                    <div className='text-center space-y-4'>
                        ...
                        <p className='font-semibold text-[10px] md:text-base w-40 md:w-2xl mx-auto'>Easily borrow and return books with our seamless library system.</p>
                        <button className='btn bg-[#3C393B] text-white'>Learn More</button>
                    </div>
                </div>
                <div className="absolute left-5 right-5 top-1/2 flex -translate-y-1/2 transform justify-between">
            ...
            <div id="slide3" className="carousel-item relative w-full bg-[url(/banner-3.jpg)] bg-cover bg-no-repeat">
                <div className='flex justify-center items-center w-full'>
                    <div className='text-center space-y-4'>
                        ...
                        <p className='font-semibold text-[10px] md:text-base w-40 md:w-2xl mx-auto'>Be the first to know about the latest books added to our collection.</p>
                        <button className='btn bg-[#3C393B] text-white'>Learn More</button>
                    </div>
                </div>
                <div className="absolute left-5 right-5 top-1/2 flex -translate-y-1/2 transform justify-between">
